...
public class OfficeReaderActivity extends AppCompatActivity implements IMainFrame {
...
//        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == android.R.id.home) {
            ...
            shareToOther("com.google.android.apps.docs");
            return false;
//        }else if (itemId == R.id.print){
//            PrintManager printManager = (PrintManager) getSystemService(Context.PRINT_SERVICE);
//            try {
//                PrintDocAdapter printAdapter = new PrintDocAdapter(AppActivity.this,new File(filePath));
//
//                printManager.print(
//                        "Document",
//                        printAdapter,
...
//                }
    ...
    private void setFilePath() {
        ...
        filePath = getFilePathForN(intent.getData(), this);
