...
public class OfficeReaderAdsLoadingActivity extends AppCompatActivity {
...
//                Log.i(TAG, "onAdLoaded");
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(OfficeReaderAdsLoadingActivity.this);
    ...
    void gotoRead(){
        Intent intent = new Intent(this,OfficeReaderActivity.class);
