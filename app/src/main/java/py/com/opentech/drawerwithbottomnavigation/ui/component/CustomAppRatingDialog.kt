...
class CustomAppRatingDialog private constructor(
     ...
     */
    fun setTargetFragment(fragment: Fragment, requestCode: Int): CustomAppRatingDialog {
     ...
     */
    fun show() {
        CustomAppRatingDialogFragment.newInstance(data).apply {
            fragment?.let {
...
//
    fun shouldShowRateDialog(): Boolean {
        return true;// PreferenceHelper.getIsAgreeShowDialog(context) &&
//                isOverLaunchTimes() &&
//                isOverInstallDate() &&
//                isOverRemindDate()
    }
...
//        return PreferenceHelper.getLaunchTimes(context) >= data.numberOfLaunches
//    }
//
//    private fun isOverInstallDate(): Boolean {
//        return isOverDate(PreferenceHelper.getInstallDate(context), data.afterInstallDay)
//    }
//
//    private fun isOverRemindDate(): Boolean {
//        return isOverDate(PreferenceHelper.getRemindInterval(context), data.remindInterval)
//    }
...
//    }
    ...
    class Builder : Serializable {
         ...
         */
        fun create(activity: FragmentActivity): CustomAppRatingDialog {
            Preconditions.checkNotNull(activity, "FragmentActivity cannot be null")
            return CustomAppRatingDialog(activity, data, activity.applicationContext)
        }
